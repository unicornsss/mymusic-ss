...
<body>
<div class="wrapper">
    <form action="<%=request.getContextPath()%>/music/doRegister" method="post">
        <div class="loginBox">
            <div class="loginBoxCenter">
                <p><label for="accountNumber">账号：</label></p>
                <!--autofocus 规定当页面加载时按钮应当自动地获得焦点。 -->
                <!-- placeholder提供可描述输入字段预期值的提示信息-->
                <p><input type="text" id="accountNumber" name="accountNumber" class="loginInput" autofocus="autofocus" required="required" autocomplete="off" placeholder="请输入账号" value="" /></p>
